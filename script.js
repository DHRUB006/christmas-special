...
function endMessage()
{
  ...
  steveEl.addEventListener('click', event => {
    ...
    window.open('https://www.instagram.com/dhrubajyoti.official/', '_blank');
  });
  ...
  // Be sure to send a screenshot to <a href="https://www.instagram.com/dhrubajyoti.official/" target="_blank">@dhrubajyoti.official</a>, he’d love to see it!`;
